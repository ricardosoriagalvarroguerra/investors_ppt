...
function Slide16({ active }) {
  ...
  return (
    <div className="s16">
      <svg ref={svgRef} className="s16__bg" />
      <div className="s16__grid">
        {Array.from({ length: 12 }).map((_, i) => <div key={i} className="s16__grid-col" />)}
      </div>

      <header className="s16__top">
        <div className="s16__chapter">Chapter 02</div>
        <div className="s16__progress">
          <span className="s16__progress-current">02</span>
          <span className="s16__progress-divider">/</span>
          <span className="s16__progress-total">04</span>
        </div>
      </header>

      <main className="s16__main">
        <div className="s16__index">02</div>
        <div className="s16__title-block">
          <div className="s16__eyebrow">Section</div>
          <h1 className="s16__title">
            Financial<br />
            <span className="s16__title-thin">Highlights</span>
          </h1>
          <div className="s16__rule"></div>
          <p className="s16__lede">
            Strong capitalization, consistent growth, and a balance sheet built for resilience through the cycle.
          </p>
        </div>
      </main>

      <footer className="s16__foot">
        <div className="s16__foot-stat">
          <span className="s16__foot-num">USD 4.1bn</span>
          <span className="s16__foot-lab">Total assets</span>
        </div>
        <div className="s16__foot-stat">
          <span className="s16__foot-num">19%</span>
          <span className="s16__foot-lab">CAGR · gross loans</span>
        </div>
        <div className="s16__foot-stat">
          <span className="s16__foot-num">0%</span>
          <span className="s16__foot-lab">NPL · 20-year track</span>
        </div>
        <div className="s16__foot-stat">
          <span className="s16__foot-num">A+ / A2</span>
          <span className="s16__foot-lab">S&P / Moody's</span>
        </div>
      </footer>
    </div>
  );
