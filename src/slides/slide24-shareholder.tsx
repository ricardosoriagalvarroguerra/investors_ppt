  ...
  return (
    <div className="s24">
      <header className="s17__head">
        <div className="s17__h-num">24 · Shareholder support</div>
        <h2 className="s17__h-title">Continuous <span className="thin">shareholder support</span></h2>
        <div className="s17__h-meta">Subscribed capital evolution<br />USD million</div>
      </header>

      <div className="s24__body">
        <div className="s24__chart-wrap">
          <svg ref={ref} className="s24__chart" />
        </div>

        <div className="s24__legend">
          <div><span className="s24__sw s24__sw--paid"></span>Paid-in</div>
          <div><span className="s24__sw s24__sw--ppaid"></span>Pending paid-in</div>
          <div><span className="s24__sw s24__sw--call"></span>Callable capital</div>
          <div><span className="s24__sw s24__sw--pcall"></span>Pending callable</div>
        </div>
      </div>

      <div className="s24__pull">
        <strong>The 2ⁿᵈ General Capital Increase (GCI)</strong> finishes integrating pending paid-in capital by 2026.
      </div>
