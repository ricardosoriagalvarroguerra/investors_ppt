...
function Slide18({ active }) {
  ...
  return (
    <div className="s18">
      <header className="s18__head">
        <div className="s18__h-num">18 · Loan portfolio</div>
        <h2 className="s18__h-title">Gross Loan <span className="thin">Portfolio</span></h2>
        <div className="s18__h-meta">Consistent growth · high quality<br />USD million</div>
      </header>

      <div className="s18__body">
        <aside className="s18__rail">
          <div className="s18__metric">
            <button
              type="button"
              className="s18__info"
              aria-label="CAGR indicator definition"
              data-tooltip="Compound annual growth rate of the gross loan portfolio over the selected 10-year period."
            >
              i
            </button>
            <div className="s18__metric-eye">CAGR · 10 years</div>
            <div className="s18__metric-num">
              <CountUp to={19} duration={900} play={active} />%
            </div>
            <div className="s18__metric-sub">Dec-15 → Dec-25</div>
          </div>
          <div className="s18__metric s18__metric--accent">
            <button
              type="button"
              className="s18__info"
              aria-label="NPL and NAI indicator definition"
              data-tooltip="NPL and NAI indicate non-performing loans and non-accrual interest; FONPLATA has maintained 0% over the last 20 years."
            >
              i
            </button>
            <div className="s18__metric-eye">NPL · NAI</div>
            <div className="s18__metric-num">0%</div>
            <div className="s18__metric-sub">Last 20 years</div>
          </div>
          <div className="s18__metric">
            <div className="s18__metric-eye">Selected period</div>
            <div className="s18__metric-num">{sel.y}</div>
            <div className="s18__metric-sub">USD {sel.v.toLocaleString()}M · LLP {sel.llp}%</div>
          </div>

          <div className="s18__legend">
            <div><span className="s18__legend-bar"></span>Gross Loan Portfolio</div>
            <div><span className="s18__legend-line"></span>LLP / Gross Loans</div>
          </div>
        </aside>

        <div className="s18__chart-wrap">
          <svg ref={ref} className="s18__chart" />
        </div>
      </div>

      <footer className="s18__foot">
        Source · Preliminary financial statements as of December 31, 2025.<br />
        (*) Loan loss ratio defined as Loan Loss Provision / Gross Loans.
      </footer>
    </div>
  );
}
