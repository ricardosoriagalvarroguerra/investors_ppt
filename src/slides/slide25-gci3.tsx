...
function Slide25({ active }) {
  ...
  useEffect(() => {
    ...
    const layers = [
      { key: "cE", fill: "var(--chart-5)", dash: false, color: "#14181F" },
      { key: "pE", fill: "var(--chart-2)", dash: false, color: "var(--on-accent)" },
      { key: "pp", fill: "var(--chart-4)", dash: true,  color: "#14181F" },
      { key: "cn", fill: "var(--chart-7)", dash: true,  color: "#14181F" },
  ...
  return (
    <div className="s25">
      <header className="s17__head">
        <div className="s17__h-num">25 · 3ʳᵈ GCI</div>
        <h2 className="s17__h-title">3<sup>rd</sup> GCI <span className="thin">subscribed</span></h2>
        <div className="s17__h-meta">Paid-in contributions begin 2027<br />USD million · projection</div>
      </header>

      <div className="s25__body">
        <div className="s25__chart-wrap">
          <svg ref={ref} className="s25__chart" />
        </div>

        <div className="s25__legend">
          <div><span className="s25__sw s25__sw--cE"></span>Callable</div>
          <div><span className="s25__sw s25__sw--pE"></span>Paid-in</div>
          <div><span className="s25__sw s25__sw--pp"></span>Pending paid-in members</div>
          <div><span className="s25__sw s25__sw--cn"></span>Pending callable for new members</div>
          <div><span className="s25__sw s25__sw--pn"></span>Pending paid-in new members</div>
        </div>

        <ul className="s25__bullets">
          <li>
            <span className="s25__num">i</span>
            <span>In <strong>February 2024</strong>, the Board of Governors approved a <strong>new General Capital Increase (GCI)</strong>, doubling FONPLATA's authorized capital from <strong>USD 3.0 bn to USD 6.5 bn</strong> — enabling future capital subscription, new partners, and a stronger lending capacity.</span>
          </li>
          <li>
            <span className="s25__num">ii</span>
            <span>On <strong>July 31, 2025</strong>, the Board of Governors approved the <strong>subscribed capital increase</strong>, enabling the inclusion of new members under: ~18.182% of total share capital in <em>Class B</em> shares for new member countries; ~81.818% in <em>Class A</em> shares for founding member countries.</span>
          </li>
          <li>
            <span className="s25__num">iii</span>
            <span>Integration of the 3ʳᵈ GCI paid-in capital will <strong>begin in 2027 and complete by 2036</strong>.</span>
          </li>
        </ul>
      </div>
